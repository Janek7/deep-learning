...
parser.add_argument("--pooling", default="avg", type=str, help="Type of pooling.")
...
class Agent:
    def __init__(self, env: wrappers.EvaluationEnv, args: argparse.Namespace) -> None:
        ...
        # 40x40x64
        conv1 = self.bn_relu(tf.keras.layers.Conv2D(64, 3, 2, "same")(inputs))
        # 20x20x64
        conv2 = self.bn_relu(tf.keras.layers.Conv2D(128, 3, 2, "same")(conv1))
        # 10x10x64
        conv3 = self.bn_relu(tf.keras.layers.Conv2D(256, 3, 2, "same")(conv2))
