...
def main(args: argparse.Namespace) -> Dict[str, float]:
    ...
    train_generator = tf.keras.preprocessing.image.ImageDataGenerator(rotation_range=20, zoom_range=.2,
    ...
    logs = model.fit(
        train_generator.flow(cifar.train.data["images"], cifar.train.data["labels"], batch_size=args.batch_size, seed=args.seed),
